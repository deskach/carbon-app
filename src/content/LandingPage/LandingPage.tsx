...
const defaultProps: LandingPageProps = {
  tabs: {
    selected: 0,
    role: TabRole.Navigation,
  },
  tab: {
    role: TabRole.Presentation,
    tabIndex: 0,
  },
};

export const LandingPage: React.FunctionComponent<LandingPageProps> = (props= defaultProps) => {
  return (
    <div className="bx--grid bx--grid--full-width landing-page">
      <div className="bx--row landing-page__banner">
        <div className="bx--col-lg-16">
          <Breadcrumb noTrailingSlash aria-label="Tab navigation">
            <BreadcrumbItem>
